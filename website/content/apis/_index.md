...
| `gracefulRestart` _boolean_ | GracefulRestart allows BGP peer to continue to forward data packets along known routes while the routing protocol information is being restored. Needed for FRR mode only. |
